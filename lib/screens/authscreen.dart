                          ...
                          Row(
                            ...
                            children: [
                              DropdownButton<String>(
                                  ...
                                  onChanged: (value) {
                                    typetext = value!;
                                    if (typetext == 'I am a Retailer') type = 1;
                                    if (typetext == 'I am an Exporter') {
                                      type = 2;
                                    }
                                    if (typetext == 'I am a Farmer/Producer') {
                                      type = 3;
                                    }
                                    if (typetext == 'I am a Manufacturer') {
                                      type = 4;
                                    }
                                  }
                                  //value: typetext,
                                  ...
                                  if (_formKey.currentState!.validate() &&
                                    ...
                                    try {
                                      Provider.of<MainProvider>(context,
                                              listen: false)
                                          .addlogindata(type.toDouble(), name!,
                                              businuess!, email!, mobile!);
                                    } catch (e) {
                                      print(e.toString());
                                      return;
                                    }
                                    ...
                                    onPressed: () async {
                                      await signInWithGoogle()
                                        ...
                                        if (result != null &&
                                          ...
                                          print(
                                              'Your doc is empaty hence cant login into this bachchu');
                                        }
                                      }).catchError((error) {
